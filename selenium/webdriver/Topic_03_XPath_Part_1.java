...
public class Topic_03_XPath_Part_1 {
	...
	public void TC_01_Empty_Data() {
		...
		// Verify: 3 ham
			// Assert.assertTrue -> Kiem tra 1 dk tra ve la dung
			// Assert.assertFalse -> Kiem tra 1 dk tra ve la Sai
	...
	public void TC_02_Invalid_Email() {
		...
		driver.findElement(By.id("txtPassword")).sendKeys("12345789");
		driver.findElement(By.id("txtCPassword")).sendKeys("12345789");
		driver.findElement(By.id("txtPhone")).sendKeys("012345789");
	...
	public void TC_05_Incorrect_Password() {
		...
		driver.findElement(By.id("txtCPassword")).sendKeys("123456456");
		driver.findElement(By.id("txtPhone")).sendKeys("012345789");
	...
	public void TC_06_Invalid_Phone() {
		...
		driver.findElement(By.id("txtPassword")).sendKeys("123456789");
		driver.findElement(By.id("txtCPassword")).sendKeys("123456456");
		driver.findElement(By.id("txtPhone")).sendKeys("01234578");
		...
		Assert.assertEquals(driver.findElement(By.id("txtPhone-error")).getText(), "Số điện thoại phải từ 10-11 số. ");
			...
			//Action 2
				//Chi nhap lai phone sau khi xoa du lieu cu di
				driver.findElement(By.id("txtPhone")).clear();
				driver.findElement(By.id("txtPhone")).sendKeys("012345789012");
